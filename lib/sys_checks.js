    ...
    clearSpace:function(callback){
        ...
        async.series([
                function(series_cb){
                    ...
                    return _sys_checks.deleteLocal(_sys_checks.app.config.camera.local_photos, series_cb);
                },
                function(series_cb){
                    //delete whatever is in the zips directory
                    return _sys_checks.deleteLocal(_sys_checks.app.config.camera.local_zips, series_cb);
                }
            ],
            callback
        );
